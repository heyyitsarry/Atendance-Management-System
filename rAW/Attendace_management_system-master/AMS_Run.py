    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/HP/OneDrive/Desktop/Attendence system/rAW/Attendace_management_system-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\HP\OneDrive\Desktop\Attendence system\rAW\Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\HP\OneDrive\Desktop\Attendence system\rAW\Attendace_management_system-master\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Vedant' :
            if password == 'Vedant20':
                ...
                cs = 'C:/Users/HP/OneDrive/Desktop/Attendence system/rAW/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
